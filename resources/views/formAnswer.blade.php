...
@section('content')
 <h1>Leave your answer here</h1>
    <form role="form" class="form" id="form" action="addAnswer" method="get">
        ...
        <input type="hidden" name="typeOfCom" value="answer">
        <input type="hidden" value="{!! $positionOfCom !!}"  name="positionOfCom">
        {{--<a class="preview_answer btn btn-default">Preview</a>--}}
